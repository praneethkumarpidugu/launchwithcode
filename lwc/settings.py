...
SECRET_KEY = 'l!pqf92gb7_oa*@(4mznz)@wgr14p1rig6c^myvg_isc+&6^kl'
...
TEMPLATE_DIRS = (
    ...
    #BASE_DIR + "/templates/",
    #'/home/praneeth/launchwithcode/lwc/templates/',
)
...
STATICFILES_DIRS = (
    ...
    #'/home/praneeth/launchwithcode/lwc/static/static_dirs/',
)
